...
- `p_ge(15)` is the probability the roll is **≥ 15** (meet or beat the target).
- The output is a single probability, not a full table.
...
[Lesson 5: Dice notation step by step](05-dice-notation.md)
